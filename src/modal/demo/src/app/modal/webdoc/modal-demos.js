export default {
  ...
  demos: [
    ...
    },
    {
      ...
      desc: {
        'zh-CN':
          '<p>弹出框内容定义为组件形式时，弹出框中的内容组件需要在<code>ngModule</code>中定义其为<code>entryComponents</code>。</p>',
        'en-US': '<p>component</p>',
      },
      apis: [
        'TiModalConfig.properties.context',
        'TiModalConfig.methods.close',
        'TiModalConfig.methods.dismiss',
      ],
    },
    {
      demoId: 'modal-class',
    ...
    },
    {
      ...
      desc: {
        'zh-CN':
          '<p>通过<code>animation</code>控制弹出框显示/隐藏是否带动画效果。</p>',
        'en-US': 'animation',
      },
    ...
    },
    {
      ...
      desc: {
        'zh-CN':
          '<p>通过<code>closeOnEsc</code>控制按 Esc 键弹出框是否关闭。</p>',
        'en-US': 'closeOnEsc',
      },
    ...
    },
    {
      ...
      desc: {
        'zh-CN':
          '<p>通过<code>headerAlign</code>配置头部内容水平对齐方式。</p>',
        'en-US': 'headerAlign',
      },
    ...
    },
    {
      ...
      desc: {
        'zh-CN':
          '<p>通过<code>beforeClose</code>配置关闭弹出框前的回调函数。</p>',
        'en-US': 'beforeClose',
      },
      apis: [
        'TiModalConfig.methods.beforeClose',
        'TiModalConfig.methods.close',
        'TiModalConfig.methods.dismiss',
      ],
    },
