...
@Component({
  templateUrl: './checkgroup-disabled-test.html'
})
export class CheckgroupDisabledTestComponent {
  // 数据列表
  ...
  checkedArray6: Array<any> = [this.dataArray6[2], this.dataArray6[1], this.dataArray6[3]];
