export default {
  ...
  demos: [
    ...
    },
    {
      ...
      desc: {
        'zh-CN': '<p>通过属性<code>parentCheckable</code>配置多选树时父节点是否支持选中。</p>',
        'en-US': 'tree parentcheckable'
      },
    ...
    },
    {
      ...
      desc: {
        'zh-CN': '<p>通过属性<code>checkRelation</code>配置父子节点选中时是否具有关联关系。</p>',
        'en-US': 'tree check relation'
      },
    ...
    },
    {
      ...
      desc: {
        'zh-CN': '<p>通过属性<code>changedByCheckbox</code>配置是否只有点击 checkbox 能选中树节点，仅为多选树时生效。</p>',
        'en-US': 'tree changedbycheckbox'
      },
    ...
    },
    {
      ...
      desc: {
        'zh-CN': '<p>通过模板<code>item</code>配置树节点的内容。</p>',
        'en-US': 'tree template'
      },
    ...
    },
    {
      ...
      desc: {
        'zh-CN': '<p>通过属性<code>nodeDraggable</code>配置是否支持拖拽；当拖拽入目标树节点的时候触发<code>nodeDrop</code>事件。</p>',
        'en-US': 'tree drag'
      },
      apis: ['TiTreeComponent.properties.nodeDraggable', 'TiTreeComponent.events.nodeDrop']
    },
    {
    ...
    },
    {
      ...
      apis: ['TiTreeComponent.events.beforeExpand', 'TiTreeComponent.methods.getBeforeExpandNode', 'TiTreeComponent']
    },
    {
      ...
      desc: {
        'zh-CN': '<p>当点击更多按钮的时候触发<code>beforeExpand</code>事件，一般用于大数据需要分段加载的场景。</p>',
        'en-US': 'tree before more'
      },
    ...
    },
    {
      ...
      desc: {
        'zh-CN': '<p>使用 Searchbox 组件配合实现树搜索的场景。</p>',
        'en-US': 'tree search'
      },
    ...
    },
    {
      ...
      desc: {
        'zh-CN': '<p>通过属性<code>virtual</code>配置是否开启虚拟滚动，虚拟滚动时需要设置高度。</p>',
        'en-US': 'tree virtualscroll'
      },
