...
export class TreeUtilComponent implements OnInit, AfterViewInit {
  ...
  ngAfterViewInit(): void {
    console.log(TiTreeUtil.getParentNode(this.innerData, this.innerData[0].children[0].children[0]));
  }
  ...
  deSelectNode(): void {
    const data: Array<TiTreeNode> = this.arr.concat();
    TiTreeUtil.deSelectNode(data, data[0].children[0].children[0].children[0], true);
