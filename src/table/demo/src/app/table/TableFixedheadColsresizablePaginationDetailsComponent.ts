...
@Component({
  ...
  templateUrl: './table-fixedhead-colsresizable-pagination-details.html'
})
export class TableFixedheadColsresizablePaginationDetailsComponent implements OnInit {
