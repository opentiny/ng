...
@NgModule({
  imports: [CommonModule, FormsModule, TiProgresspieModule, RouterModule.forChild(ProgresspieTestModule.ROUTES)],
  declarations: [ProgresspieTestComponent]
})
export class ProgresspieTestModule {
  static readonly LINKS: Array<object> = [{ href: 'components/TiProgresspieComponent.html', label: 'Progresspie' }];
