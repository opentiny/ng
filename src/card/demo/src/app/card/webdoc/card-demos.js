export default {
  ...
  demos: [
    ...
    },
    {
      ...
      desc: {
        'zh-CN': '<p>使用栅格布局需要导入<code>TiGridModule</code>模块，根据栅格体系，自适应依据规范定义的四种分辨率 xs：1280~1439【1280、1366】， sm:1440~1599【1440】，md:1600~1759【1680】, lg: 1760~1920【1920】，通过不同的样式类设置子元素的宽度，使用 ti3-row 定义一行，使用 ti-col-xs-[num] 设置一行所所占的比。</p>',
        'en-US': '<p>card icon</p>',
      }
    },
    {
