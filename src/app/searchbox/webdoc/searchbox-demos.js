export default {
  ...
  demos: [
    ...
    },
    {
      ...
      desc: {
        'zh-CN':
          '<p>通过<code>trimmed</code>配置是否删除用户搜索内容的首尾空格，不配置时不删除空格。</p>',
        'en-US': '<p>trimmed</p>',
      },
    ...
    },
    {
      ...
      desc: {
        'zh-CN':
          '<p>通过<code>suggest</code>事件配置当聚焦或值改变时触发事件，为开发者提供设置建议项的时机。</p>',
        'en-US': '<p>item</p>',
      },
      apis: [
    ...
    },
    {
      ...
      desc: {
        'zh-CN':
          '<p>通过<code>panelWidth</code>配置下拉框的宽度。通过<code>panelMaxHeight</code>配置面板最大高度。</p>',
        'en-US': '<p>item</p>',
      },
      apis: [
        'TiSearchboxComponent.properties.panelWidth',
        'TiSearchboxComponent.properties.panelMaxHeight',
      ],
    },
    {
