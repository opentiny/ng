  ...
  demos: [
    {
      ...
      apis: [
        'TiSkeletonComponent.properties.type'
      ],
      codeFiles: [
        'skeleton-type.html',
        'SkeletonTypeComponent.ts',
        'skeleton.less'
      ]
    },
    {
      ...
      apis: [
        'TiSkeletonComponent.properties.title',
      ],
      codeFiles: [
        'skeleton-title.html',
        'SkeletonTitleComponent.ts',
        'skeleton.less'
      ]
    },
    {
      ...
      desc: {
        'zh-CN': '<code>skeleton</code>组件在典型页面中使用。',
        'en-US': '<p>skeleton page</p>',
      },
      codeFiles: [
        'skeleton-page.html',
        'SkeletonPageComponent.ts',
        'skeleton-page.less'
      ]
    },
  ],
