...
@Component({
  ...
  templateUrl: './table-fixed-head-nodata.html',
})
export class TableFixedHeadNodataComponent implements OnInit {
  ...
  noGoodsInfo: string = '您还没有购买任何商品，去';
  goShopInfo: string = '购买商品';
