...
@Component({
  ...
  templateUrl: './table-virtualscroll-sizes.html',
})
export class TableVirtualscrollSizesComponent implements OnInit {
  ...
  changeFew(): void {
    this.srcData.data = this.getData(3);
  }
