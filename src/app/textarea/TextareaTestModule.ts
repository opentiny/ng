...
export class TextareaTestModule {
  ...
  static readonly LINKS: Array<object> = [
    { href: 'components/TiTextareaComponent.html', label: 'Textarea' }
  ];
  static readonly ROUTES: Routes = [
    ...
    { path: 'textarea/textarea-width',
      component: TextareaWidthComponent
    },
    { path: 'textarea/textarea-valid',
      component: TextareaValidComponent
    },
    { path: 'textarea/textarea-none',
      component: TextareaNoneComponent
    },
    { path: 'textarea/textarea-scroll',
