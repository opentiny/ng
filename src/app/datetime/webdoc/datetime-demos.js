export default {
  ...
  demos: [
    ...
    },
    {
      ...
      apis: [
        'TiDatetimeComponent.properties.format',
    ...
    },
    {
      ...
      desc: {
        'zh-CN':
          '<p>通过属性<code>max</code>配置配置可选择日期时间的最大值；通过属性<code>min</code>配置可选择日期时间的最小值。</p>',
        'en-US': '',
      },
      apis: [
        'TiDatetimeComponent.properties.max',
        'TiDatetimeComponent.properties.min',
      ],
    },
    {
    ...
    },
    {
      ...
      desc: {
        'zh-CN':
          '<p>通过属性<code>customizeOptions</code>自定义下拉面板内容，设置可快捷选择的常用日期时间。</p>',
        'en-US': '',
      },
      apis: [
    ...
    },
    {
      ...
      desc: {
        'zh-CN':
          '<p>通过属性<code>nowDateTime</code>自定义当前日期时间，可用于矫正实际日期时间和计算机系统日期时间的偏差。</p>',
        'en-US': '',
      },
