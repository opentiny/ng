export default {
  ...
  demos: [
    ...
    },
    {
      ...
      desc: {
        'zh-CN': '<p>通过调用<code>TiNotificationService</code>的不同方法来弹出不同类型的通知，包括：<code>success</code>、<code>prompt</code>、<code>warn</code>、<code>error</code>、<code>simple</code>。</p>',
        'en-US': '<p></p>',
      },
      apis: [
    ...
    },
    {
      ...
      apis: [
        'TiNotificationService.methods.template',
      ]
    },
    {
      ...
      apis: [
        'TiNoticeConfig.properties.duration',
      ]
    },
    {
      ...
      desc: {
        'zh-CN': '<p>通过属性<code>position</code>配置弹出位置，包括<code>top-right</code>、<code>top</code>、<code>top-left</code>、<code>bottom-left</code>、<code>bottom</code>、<code>bottom-right</code>。</p>',
        'en-US': '<p></p>',
      },
      apis: [
        'TiNoticeConfig.properties.position',
      ]
    },
    {
      ...
      apis: [
        'TiNoticeConfig.properties.animation',
      ]
    },
    {
      ...
      apis: [
        'TiNoticeConfig.properties.hoverPause',
      ]
    },
    {
      ...
      apis: [
        'TiNoticeConfig.properties.name',
      ]
    },
    {
      ...
      apis: [
        'TiNoticeConfig.properties.onClose',
      ]
    },
    {
      ...
      desc: {
        'zh-CN': '<p>通过属性<code>TiNotificationService</code>的打开通知弹窗方法，会返回一个可关闭对象，调用这个对象的<code>close</code>方法来关闭对应的通知弹窗。同时，你也可以通过<code>TiNotificationService.closeAll()</code>来关闭</p>',
        'en-US': '<p></p>',
      },
      apis: [
        'TiNotificationService.methods.closeAll',
      ]
    }
  ],
};
