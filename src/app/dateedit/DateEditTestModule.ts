...
@NgModule({
  imports: [
    ...
    FormsModule,
    TiDateEditModule,
    RouterModule.forChild(DateEditTestModule.ROUTES)
  ],
  declarations: [
    DateEditComponent,
    DateEditFormatComponent,
    DateEditMaxComponent,
    DateEditValueComponent,
    DateEditMinComponent
  ]
})
export class DateEditTestModule {
  static readonly LINKS: Array<object> = [
    { href: 'components/TiDateEditComponent.html', label: 'DateEdit' },
  ];
