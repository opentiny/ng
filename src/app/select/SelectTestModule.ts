...
export class SelectTestModule {
  ...
  static readonly LINKS: Array<object> = [
    { href: 'components/TiSelectComponent.html', label: 'Select' }
  ];
  static readonly ROUTES: Routes = [
    ...
    { path: 'select/select-small',
      component: SelectSmallComponent
    },
    { path: 'select/select-noborder',
      component: SelectNoborderComponent
    },
    { path: 'select/select-noempty',
      component: SelectNoemptyComponent
    },
    { path: 'select/select-leak',
      component: SelectLeakComponent
    },
    { path: 'select/select-valid',
      component: SelectValidComponent
    },
    { path: 'select/select-validgroup',
      component: SelectValidgroupComponent
    },
    { path: 'select/select-load',
      component: SelectLoadComponent
    },
    { path: 'select/select-many',
      component: SelectManyComponent
    },
    { path: 'select/select-input',
      component: SelectInputComponent
    },
    { path: 'select/select-id',
      component: SelectIdComponent
    },
    { path: 'select/select-much',
      component: SelectMuchComponent
    },
    { path: 'select/select-enum',
      component: SelectEnumComponent
    },
    { path: 'select/select-null',
