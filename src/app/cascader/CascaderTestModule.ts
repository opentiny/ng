...
export class CascaderTestModule {
  public static readonly ROUTES: Routes = [
    ...
    { path: 'cascader/cascader-disabled', component: CascaderDisabledComponent },
    ...
    { path: 'cascader/cascader-showalllevel', component: CascaderShowalllevelComponent },
    { path: 'cascader/cascader-onlyselectleaf', component: CascaderOnlyselectleafComponent },
    ...
    { path: 'cascader/cascader-item-test', component: CascaderItemTestComponent }
  ];
}
