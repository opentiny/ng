...
@NgModule({
  imports: [
    ...
    TiIconModule,
    DemoLogModule,
    RouterModule.forChild(MenuTestModule.ROUTES)
  ],
  declarations: [
    MenuBorderComponent,
    MenuBasicComponent,
...
export class MenuTestModule {
  static readonly LINKS: Array<object> = [
    { href: 'components/TiMenuComponent.html', label: 'Menu' }
  ];
  static readonly ROUTES: Routes = [
    ...
    { path: 'menu/menu-id',
      component: MenuIdComponent
    },
    { path: 'menu/menu-templete-test',
      component: MenuTempleteTestComponent
    },
    { path: 'menu/menu-buttoncolor',
