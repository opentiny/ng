  ...
  demos: [
    {
      ...
      desc: {
        'zh-CN':
          '<p>提供Nav组件的基本使用示例，其中包含左侧站点标题，中间导航菜单，右侧按钮。</p>',
        'en-US': '<p>nav basic</p>',
      },
    },
    {
    ...
    },
    {
      ...
      desc: {
        'zh-CN': '<p>通过属性<code>theme</code>配置 nav 组件主题，提供了深色<code>dark</code>和浅色<code>light</code>两种选项，默认使用<code>light</code>浅色主题。</p>',
        'en-US': '<p>nav theme</p>',
      },
    ...
    },
    {
      ...
      desc: {
        'zh-CN':
          '<p>右侧操作区用于放置<code>a</code>标签、<code>span</code>标签和<code>button</code>标签等元素。</p>',
        'en-US': '<p>nav right</p>',
      },
    },
    {
      ...
      desc: {
        'zh-CN': '<p>导航菜单区域采用了<code>display: flex</code>布局，可以通过修改<code>justify-content</code>属性来设置导航菜单元素的对齐方式，参考 CSS 的<code>justfy-content</code>属性。</p>',
        'en-US': '<p>nav align</p>',
      },
    },
    {
      ...
      desc: {
        'zh-CN': '<p>通过属性<code>items</code>传入菜单项数组，根据菜单对象的<code>children</code>属性嵌套层数决定了展开子菜单的方式，二级嵌套采用下拉菜单，三级嵌套采用下拉面板。</p>',
    ...
    },
    {
      ...
      desc: {
        'zh-CN':
          '<p>通过传入<code>activeId</code>修改当前激活项，被激活的菜单项及其父级菜单会有高亮显示。</p>',
        'en-US':
          '<p>nav active</p>',
      },
    ...
    },
    {
      ...
      desc: {
        'zh-CN': '<p>选择菜单项将触发选择事件，并返回对象，其中<code>item</code>为被选择的对象数据，<code>itemPath</code>是选项数组，保存了从顶层到底层被选择的每一级对象数据。</p>',
        'en-US': '<p>nav event</p>',
      },
