...
@NgModule({
  imports: [
    CommonModule,
    TiZoomModule,
    RouterModule.forChild(ZoomTestModule.ROUTES)
  ],
  declarations: [
    ZoomBasicComponent,
    ZoomChangeSrcComponent,
    ZoomTestComponent,
    ZoomRatioComponent
  ]
})
export class ZoomTestModule {
  static readonly LINKS: Array<object> = [
    { href: 'directives/TiZoomDirective.html', label: 'Zoom' }
  ];
  static readonly ROUTES: Routes = [
    ...
    { path: 'zoom/zoom-change-src',
      component: ZoomChangeSrcComponent
    }, // 自测用例，改变src属性
    { path: 'zoom/zoom-test',
