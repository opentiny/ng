export default {
  ...
  demos: [
    ...
    },
    {
      ...
      desc: {
        'zh-CN':
          '<p>通过属性<code>max</code>配置可选择日期范围的最大值；通过属性<code>min</code>配置可选择日期范围的最小值。</p>',
        'en-US': '',
      },
      apis: [
        'TiDateRangeComponent.properties.max',
        'TiDateRangeComponent.properties.min',
      ],
    },
    {
    ...
    },
    {
      ...
      apis: [
        'TiDateRangeComponent.events.dayClick',
        'TiDateRangeComponent.events.okClick',
      ],
    },
    {
    ...
    },
    {
      ...
      desc: {
        'zh-CN':
          '<p>通过属性<code>isAllowBeginEqualEnd</code>配置是否允许结束日期与开始日期相同。</p>',
        'en-US': '',
      },
    ...
    },
    {
      ...
      desc: {
        'zh-CN':
          '<p>通过属性<code>customizeOptions</code>自定义下拉面板内容，设置可快捷选择的常用日期范围。</p>',
        'en-US': '',
      },
      apis: [
