...
@Component({
  template: `
    ...
    <ti-modal-body>
      <ti-treeselect [options]="options" [(ngModel)]="value" placeholder="Please select" id="treeselect-modal">
      </ti-treeselect>
    </ti-modal-body>
    <ti-modal-footer>
...
export class ModalTestComponent {
  ...
  value: TiTreeNode = TiTreeUtil.getSelectedData(this.options, true, true);
  ...
  ngOnInit(): void {
    ...
    this.value = TiTreeUtil.getSelectedData(this.options, true, true);
  }
