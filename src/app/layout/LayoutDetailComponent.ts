...
export class LayoutDetailComponent {
      public items: Array<TiSubtitleItem> = [
        {
          id: '1',
          label: "ECS-name-1"
        },
    ...
    public tabs = [
        { title:'基本信息',  content:"Raw denim you probably haven't heard of them jean shorts Austin. Nesciunt tofu stumptown aliqua, retro synth master cleanse."},
