...
@Component({
    templateUrl: './layout-list-largedata.html',
    styleUrls: ['./layout.less'],
    encapsulation: ViewEncapsulation.None
})
export class LayoutListLargedataComponent implements OnInit {
    ...
    public totalNumber: number = 800;

    ngOnInit(): void {
        for (let j: number = 0; j < this.totalNumber; j++) { // 生成10条数据
