...
export class TreeManyComponent {
  ...
  selectedData1: Array<TiTreeNode> = TiTreeUtil.getSelectedData(
    this.innerData1,
    false,
    false
  );
  ...
  // 获取当前选中项，参数：树节点数据，选中项是否只包含叶子节点，是否多选
  selectedData2: Array<TiTreeNode> = TiTreeUtil.getSelectedData(
    this.innerData2,
    false,
    false
  );
  ...
  onSelect1(event: TiTreeNode): void {
    console.log(event);
    // 获取当前选中项，参数：树节点数据，选中项是否只包含叶子节点，是否多选
    this.selectedData1 = TiTreeUtil.getSelectedData(
      this.innerData1,
      false,
      false
    );
  ...
  onSelect2(event: TiTreeNode): void {
    console.log(event);
    // 获取当前选中项，参数：树节点数据，选中项是否只包含叶子节点，是否多选
    this.selectedData2 = TiTreeUtil.getSelectedData(
      this.innerData2,
      false,
      false
    );
