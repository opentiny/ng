...
@Component({
  selector: 'app-libary',
  template: `<p>I'm the content component of <span style="color: red">{{ name }}</span>.</p>`
})
...
@Component({
  ...
  template: `<p>I'm the content component of <span style="color: green">{{ place }}</span>.</p>`
})
...
@Component({
  ...
  template: `<p>I'm the content component of <span style="color: blue">{{ text }}</span>.</p>
                <p>Params: {{ type }}<p>`
})
...
@Component({
  ...
  template: `<p>I'm the content component of <span style="color: blue">{{ text }}</span>.</p>
                <p>Params: <span style="color: red">{{ concert1.suffix }}</span><p>
                <p>Params: <span style="color: red">{{ concert1.name }}</span><p>`
})
