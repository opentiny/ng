...
export class SpinnerTestModule {
  ...
  static readonly LINKS: Array<object> = [
    { href: 'components/TiSpinnerComponent.html', label: 'Spinner' }
  ];
  static readonly ROUTES: Routes = [
    ...
    { path: 'spinner/spinner-maxlength',
    ...
    { path: 'spinner/spinner-load',
      component: SpinnerLoadComponent
    },
    { path: 'spinner/spinner-max-min',
