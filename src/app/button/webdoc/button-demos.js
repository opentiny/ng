  ...
  demos: [
    {
      ...
      desc: {
        'zh-CN':
          '<p>通过属性<code>color</code>配置按钮颜色，包含<code>default</code>、<code>danger</code>、<code>primary</code>三种类型。',
    ...
    },
    {
      ...
      desc: {
        'zh-CN':
          '<p>通过属性<code>loading</code>配置按钮是否加载中状态。</p>',
    ...
    },
    {
      ...
      desc: {
        ...
        'en-US':
          '<p>A button should automatically get focus when the page loads</p>',
      },
    },
    {
      demoId: 'button-tip',
      ...
      desc: {
        'zh-CN':
          '<p>可与<code>tip</code>组件结合来显示按钮提示信息，鼠标悬停到元素上即可出现气泡提示。</p>',
