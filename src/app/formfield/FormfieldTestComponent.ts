...
@Component({
  templateUrl: './formfield-test.html',
})
export class FormfieldTestComponent {
  ...
  onClick(): void {
    console.log('fdgasdgasdg');
  }

  change(): void {
    this.item5['show'] = !this.item5['show'];
    this.item4['label'] = '重复测试：';
    this.item1['showSpan'] = !this.item1['showSpan'];
    this.item6['show'] = !this.item6['show'];
  }
