...
export class SwitchTestModule {
  ...
  static readonly LINKS: Array<object> = [
    { href: 'components/TiSwitchComponent.html', label: 'Switch' }
  ];
  static readonly ROUTES: Routes = [
    ...
    { path: 'switch/switch-focus',
      component: SwitchFocusComponent
    },
    { path: 'switch/switch-id',
      component: SwitchIdComponent
    },
    { path: 'switch/switch-load',
      component: SwitchLoadComponent
    },
    { path: 'switch/switch-event',
