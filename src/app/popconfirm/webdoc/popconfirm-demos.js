export default {
  ...
  demos: [
    ...
    },
    {
      ...
      desc: {
        'zh-CN':
          '<p>通过配置<code>TiActionmenuItem</code>接口中的内容传递数据。使用<code>tiActionmenu</code>组件，请导入<code>TiActionmenuModule</code>，具体可参考 Actionmenu 组件的使用说明。</p>',
        'en-US': '<p>PopconfirmInTable</p>',
      },
      apis: [
        'TiPopconfirmDirective.properties.data',
    ...
    },
    {
      ...
      desc: {
        'zh-CN':
          '<p>通过配置<code>TiPopconfirmConfig</code>接口的内容传递数据。</p>',
        'en-US': '<p>PopconfirmInTable</p>',
      },
      apis: ['TiPopconfirmDirective.properties.tiPopconfirm'],
    },
