  ...
  demos: [
    {
      ...
      desc: {
        'zh-CN': '<p>通过属性<code>format</code>配置时间显示的格式。包括 HH:mm:ss、HH:mm、HH、mm:ss 四种格式。</p>',
        'en-US': '<p>format</p>'
      },
    ...
    },
    {
      ...
      apis: ['TiTimeComponent.properties.max', 'TiTimeComponent.properties.min']
    },
    {
    ...
    },
    {
      ...
      desc: {
        'zh-CN': '<p>当时间框内值改变的时候触发<code>ngModelChange</code>事件。</p>',
        'en-US': '<p>event</p>'
      }
    },
    {
