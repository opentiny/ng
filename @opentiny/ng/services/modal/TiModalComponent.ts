...
import {
    ...
    Component, ElementRef, HostListener, Inject, Optional, Renderer2, ViewChild, ViewEncapsulation
} from '@angular/core';
...
export class TiModalComponent extends TiBaseComponent implements AfterContentInit {
    ...
    constructor(ele: ElementRef, private tiRenderer: TiRenderer, protected renderer: Renderer2, @Optional() private router: Router,
                protected changeDetectorRef: ChangeDetectorRef, @Inject(DOCUMENT) private document) {
        super(ele, renderer);
    }
    ...
    ngAfterContentInit(): void {
        ...
        this.modalSubscribe = this.router?.events.pipe(
