 ...
 *
 */
import { ChangeDetectionStrategy, ChangeDetectorRef, Component, ContentChild, ElementRef, EventEmitter, Input, NgZone, Output,
         Renderer2, SimpleChange, SimpleChanges, TemplateRef } from '@angular/core';
...
export class TiAnchorComponent extends TiBaseComponent {
    ...
    private onWindowScroll(): void {
        ...
        const scrollTop: number = this.scrollTarget?.scrollTop || document.documentElement.scrollTop || window.pageYOffset || document.body.scrollTop;
