 ...
 *
 */
import { Component, EventEmitter, Input, Output, ElementRef, Renderer2, Inject, ChangeDetectionStrategy, ChangeDetectorRef, ViewChild, ContentChild, ContentChildren, QueryList } from '@angular/core';
  ...
  animations: [
      trigger('alertAnimate', [
        transition(':leave', [
            ...
            animate('0.3s cubic-bezier(0.42, 0, 1, 1)',
              style({
                opacity: 0,
                transform: 'scaleY(0)',
                transformOrigin: '0% 0%'
...
export class TiAlertComponent extends TiBaseComponent {
     ...
     * @ignore
     */
    @ContentChildren(TiAlertMessageComponent) alertMessageComs: QueryList<TiAlertMessageComponent>;
    /**
     * @ignore
     * 激活项下标
     */
    ...
    constructor(protected hostRef: ElementRef, protected renderer: Renderer2, protected changeDetectorRef: ChangeDetectorRef, @Inject(DOCUMENT) private document) {
