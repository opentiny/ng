...
export class TiUploadbaseComponent extends TiBaseComponent implements OnInit {
     ...
     */
    @Output() readonly removeItems: EventEmitter<Array<TiFileItem | TiUploadInitFile | TiUploadimageInitFile>> = new EventEmitter<Array<TiFileItem | TiUploadInitFile | TiUploadimageInitFile>>();
    /**
     ...
     */
    @Output() readonly beforeRemoveItems: EventEmitter<Array<TiFileItem | TiUploadInitFile | TiUploadimageInitFile>> = new EventEmitter<Array<TiFileItem | TiUploadInitFile | TiUploadimageInitFile>>();
