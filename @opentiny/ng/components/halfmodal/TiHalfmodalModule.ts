...
import { TiPopupModule } from '../../services/popup/TiPopupModule';
...
@NgModule({
  ...
  exports: [TiHalfmodalComponent, TiHalfmodalHeaderComponent, TiHalfmodalFooterComponent, TiHalfmodalBodyComponent,
    TiHalfmodalContainerComponent],
  declarations: [TiHalfmodalComponent, TiHalfmodalHeaderComponent, TiHalfmodalFooterComponent, TiHalfmodalBodyComponent,
    TiHalfmodalContainerComponent]
})
