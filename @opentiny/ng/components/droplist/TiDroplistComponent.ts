 ...
 *
 */
import { ChangeDetectionStrategy, ChangeDetectorRef, Component, ContentChild, ElementRef, EventEmitter, HostListener, Input,
    NgZone, Output, Renderer2, SimpleChanges, TemplateRef, ViewChild } from '@angular/core';
...
export class TiDroplistComponent extends TiFormComponent {
    ...
    constructor(protected hostRef: ElementRef, protected render: Renderer2, public changeDetectorRef: ChangeDetectorRef,
    ...
    private getCdkViewportSize: () => number = (): number => {
        ...
        const contentMaxHeight: number = this.multiple && this.listCom?.selectAll && this.listCom.options?.length > 0
            ? this.virtualScrollViewportMaxHeight - TiListComponent.OPTION_DEFAULT_HEIGHT : this.virtualScrollViewportMaxHeight;
