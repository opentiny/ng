...
import { Component, ElementRef, HostListener, Input, IterableDiffer, IterableDiffers,
     Renderer2, SimpleChanges, ChangeDetectorRef, ChangeDetectionStrategy } from '@angular/core';
import { TiCheckboxComponent } from '../checkbox/TiCheckboxComponent';
...
export class TiCheckitemComponent extends TiCheckboxComponent {
    ...
    constructor(protected hostRef: ElementRef, protected renderer: Renderer2, protected changeDetectorRef: ChangeDetectorRef, protected iterableDiffers: IterableDiffers) {
